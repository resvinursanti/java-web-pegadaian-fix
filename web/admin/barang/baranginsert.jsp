<%-- 
    Document   : baranginsert
    Created on : Apr 18, 2018, 2:54:27 PM
    Author     : Evi
--%>

<%@page import="entities.JenisBarang"%>
<%@page import="dao.JenisBarangDAO"%>
<%@page import="java.util.List"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<head>
     <title>Barang Insert</title>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container">
                    ...
                    <form action="barangInsert">
                        <div>
                            <label>ID Barang</label>
                            <%if (autoid.equals("brg")) {
                            %> <input type="text" name="idBarang" value="<%= autoid%>01" readonly="true"/> <%
                            } else {
                            %> <input  type = "text" name = "idBarang" value =
                        ...
                        <div>
                            ...
                            <select name="idJenisBarang"  class="form-control" style="width:30%">
                                <% List<Object> datar = new JenisBarangDAO().getAll();
                                    for (Object data : datar) {
                                        JenisBarang c = (JenisBarang) data;%>
                                <option value="<%=c.getIdJenisBarang()%>"><%=c.getIdJenisBarang()%>-<%=c.getNamaJenisBarang()%></option>
                                <%
                                    }
                                %>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" name="namaBarang" value="" class="form-control" style="width:30%" required="">
                        </div>
                        <div>
                            <label>Kualitas</label>
                            <select name="kualitas" class="form-control" style="width:30%">
