<%-- 
    ...
    Created on : Apr 18, 2018, 2:40:37 PM
    Author     : Evi
--%>
...
<html>
  <head>
    ...
    <h2>Form Update Barang</h2>
        <%
            Object datas = (Object) session.getAttribute("barangupdates");
            Barang c = (Barang) datas;
            %>
            <form action="prosesUpdateBarang" method="POST">
                 <div>
                    <label>ID Barang</label>
                    <input type="text" name="idBarang" value="<%= c.getIdBarang()%>" readonly="true" class="form-control" style="width:30%"/>
                </div>
                <div>
                    <label>ID Jenis Barang</label>
                    <input type="text" name="idJenisBarang" value="<%= c.getIdJenisBarang()%>" readonly="true" class="form-control" style="width:30%"/>
                </div>
                <div>
                    <label>Nama Barang</label>
                    <input type="text" name="namaBarang" value="<%= c.getNamaBarang()%>" class="form-control" style="width:30%">
                </div>
                <div>
                    
                  
                    <label>Kualitas</label>
                    <select name="kualitas" value="<%= c.getKualitas()%>" class="form-control" style="width:30%">
