            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <div class="container">
                        ...
                        <form action="customerInsertAdmin">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" style="width:30%" name="nama" required="">
                            </div>
                            ...
                            <div class="radio">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" style="width:30%" name="username" required="">
                            </div>

                            <div class="form-group">
                                <label>Password</label>
                                <input type="password" class="form-control" style="width:30%" name="password" required="">
                            </div>
                            <div class="form-group">
                                <label>Nomor Telepon</label>
                                <input type="text" class="form-control" style="width:30%" name="nomorTelepon" required="">
                            </div>
                            <div class="form-group">
