...
<html>
    <head>
         <title>Jenis Barang Update</title>
...
<div class="container">
    <h2>Form Update Jenis Barang</h2>
        
        <%
            Object datas = (Object) session.getAttribute("jenisbarangupdates");
            JenisBarang c = (JenisBarang) datas;
            %>
            
            <form action="prosesUpdateJenisBarang" method="POST">
                <div>
                    <label>ID Jenis Barang</label>
                    <input type="text" name="idJenisBarang" value="<%=c.getIdJenisBarang()%>"  class="form-control" style="width:30%" readonly="true"/>
                </div>
                <div>
                    <label>Nama Jenis Barang</label>
                    <input type="text" name="namaJenis" value="<%=c.getNamaJenisBarang()%>"  class="form-control" style="width:30%">
                </div>
                <br>
                <div>
