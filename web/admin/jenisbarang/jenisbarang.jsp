        ...
        <div class="box" >
            ...
            <br>
                        <div class="text-right" style="padding-right: 10px">
                            <a href="jenisBarangAutoID" class="btn btn-sm btn-warning">Tambah Jenis Barang<i class="fa fa-arrow-circle-right"></i></a>
            ...
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <%
                        ...
                        List<Object> datas = (List<Object>) session.getAttribute("JenisBarang");
                        int i = 1;
