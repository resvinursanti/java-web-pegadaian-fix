 ...
 * @author TAMU
 */
@WebServlet(name = "CustomerControllerAdmin", urlPatterns = {"/customerControllerAdmin"})
public class CustomerControllerAdmin extends HttpServlet {
...
//            }
            ...
            dispatcher = request.getRequestDispatcher("admin/customer/customer.jsp");
